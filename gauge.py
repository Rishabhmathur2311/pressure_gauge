...
for video_name in os.listdir(TO_PREDICT_PATH):
    ...
    while success:
        ...
        # Creates lists from inference frames
        object_coordinates = []
        labels_found = []
        ...
        if "Center" in labels_found and "Needle_Tip" in labels_found:
            ...
            # Finds angle - look at trignometry and arc-tangent
            ...
            # In video, creates label for coordinates on center bbox
